...
import br.com.dwbi.dwbi.servico.ServicoMixProduto;
import br.com.dwbi.dwbi.servico.ServicoProduto;
import br.com.dwbi.dwbi.servico.ServicoVendedor;
import br.com.dwbi.dwbi.servico.ServicoPainel_Diretor_VendaSubgrupo;
import br.com.dwbi.dwbi.servico.ServicoPainel_Diretor_Vendagrupo;
...
public class BeanMixProduto implements Serializable {
	...
	public int getQtde2024i(){
		int t = 0 ;
		for(MixProduto m:lista) {
			t = t + m.getQtde2024().intValue();
		}
		return t;
	}
	...
	public float getVl2024i(){
		float t = 0 ;
		for(MixProduto m:lista) {
			t = t + m.getVl2024().floatValue();
		}
		return t;
	}
