...
public class BeanBonificacaoemGeral implements Serializable {
	...
	public void init() {
		...
		if ((Date) session.getAttribute("data1") != null) {
			...
			listavenda = servico.bonificacaoemgeral(data_grafico, data_grafico2,vendedorfiltrado,vendedorfiltrado2, gestorfiltrado, gestorfiltrado2, clientefiltrado, clientefiltrado2);
		} else {			
			listavenda = servico.bonificacaoemgeral(data_grafico, data_grafico2,vendedorfiltrado,vendedorfiltrado2, gestorfiltrado, gestorfiltrado2, clientefiltrado, clientefiltrado2);
		}
