...
@Named
@ViewScoped
public class BeanTrocaDefeitoDiferenteItem implements Serializable {
	...
	public void init() {
		...
		this.listavendaitems = servico.trocadefeitodiferenteitem(this.vendasEmGeral.getPedido());
