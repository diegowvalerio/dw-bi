...
@ManagedBean
@SessionScoped
public class BeanInvestimentoemGeralItem implements Serializable {
	...
	public void init() {
		...
		this.listavendaitems = servico.investimentoemgeralitem(this.vendasEmGeral.getPedido());
