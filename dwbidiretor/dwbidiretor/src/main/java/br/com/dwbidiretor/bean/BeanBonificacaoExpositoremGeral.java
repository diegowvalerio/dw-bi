...
@Named
@ViewScoped
public class BeanBonificacaoExpositoremGeral implements Serializable {
	...
	public void init() {
		...
		if ((Date) session.getAttribute("data1") != null) {
			...
			listavenda = servico.bonificacaoexpositoremgeral(data_grafico, data_grafico2,vendedorfiltrado,vendedorfiltrado2, gestorfiltrado, gestorfiltrado2, clientefiltrado, clientefiltrado2);
		} else {			
			listavenda = servico.bonificacaoexpositoremgeral(data_grafico, data_grafico2,vendedorfiltrado,vendedorfiltrado2, gestorfiltrado, gestorfiltrado2, clientefiltrado, clientefiltrado2);
		}
	...
	public String encaminha() {
		...
		return "bonificacaoexpositoremgeral-item";
	}
