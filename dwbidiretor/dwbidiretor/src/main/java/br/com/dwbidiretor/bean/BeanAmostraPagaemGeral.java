...
@Named
@ViewScoped
public class BeanAmostraPagaemGeral implements Serializable {
	...
	public void init() {
		...
		if ((Date) session.getAttribute("data1") != null) {
			...
			listavenda = servico.amostrapagaemgeral(data_grafico, data_grafico2,vendedorfiltrado,vendedorfiltrado2, gestorfiltrado, gestorfiltrado2, clientefiltrado, clientefiltrado2);
		} else {			
			listavenda = servico.amostrapagaemgeral(data_grafico, data_grafico2,vendedorfiltrado,vendedorfiltrado2, gestorfiltrado, gestorfiltrado2, clientefiltrado, clientefiltrado2);
		}
	...
	public String encaminha() {
		...
		return "amostrapagaemgeral-item";
	}
