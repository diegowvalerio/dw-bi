...
@Named
@ViewScoped
public class BeanInvestimentoVendedor implements Serializable {
	...
	public void init() {
		...
		if ((Date) session.getAttribute("data1") != null) {
			...
			listainvestimentovendedor = servico.investimentovendedor(data_grafico, data_grafico2,vendedorfiltrado,vendedorfiltrado2, gestorfiltrado, gestorfiltrado2);
		} else {			
			listainvestimentovendedor = servico.investimentovendedor(data_grafico, data_grafico2,vendedorfiltrado,vendedorfiltrado2, gestorfiltrado, gestorfiltrado2);
		}
