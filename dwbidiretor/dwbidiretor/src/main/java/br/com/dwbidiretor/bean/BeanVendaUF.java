...
@Named
@ViewScoped
public class BeanVendaUF implements Serializable {
	private static final long serialVersionUID = 1L;

	private VendaUF vendauf = new VendaUF();

	@Inject
	private ServicoVendaUF servico;
	private List<VendaUF> lista = new ArrayList<>();
	private List<VendaUF> lista2 = new ArrayList<>();
	...
	public void filtrar(){
		...
		lista = servico.vendauf(ano, mes);
		lista2 = servico.vendaufpedido(ano, mes);
	
	}
	
	public String getTotal1() {
		float total = 0;
		for (VendaUF v : getLista()) {
	...
	public List<VendaUF> getLista2() {
		return lista2;
	}

	public void setLista2(List<VendaUF> lista2) {
		this.lista2 = lista2;
	}
	...
	public VendaUF getVendauf() {
		return vendauf;
	}

	public void setVendauf(VendaUF vendauf) {
		this.vendauf = vendauf;
	}

	public List<VendaUF> getLista() {
		return lista;
	}

	public void setLista(List<VendaUF> lista) {
		this.lista = lista;
	}
