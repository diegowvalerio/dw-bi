...
@ManagedBean
@SessionScoped
public class BeanBrindeemGeralItem implements Serializable {
	...
	public void init() {
		...
		this.listavendaitems = servico.brindeemgeralitem(this.vendasEmGeral.getPedido());
