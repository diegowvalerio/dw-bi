...
import br.com.dwbidiretor.servico.ServicoVendasEndereco;
import br.com.dwbidiretor.servico.ServicoVendedor;

@Named
@ViewScoped
public class BeanVendasEndereco implements Serializable {
	private static final long serialVersionUID = 1L;

	private VendasEndereco vendasEndereco = new VendasEndereco();
	@Inject
	private ServicoVendasEndereco servico;
	private List<VendasEndereco> listavenda = new ArrayList<>();
	...
	public void init() {
		...
		if ((Date) session.getAttribute("data1") != null) {
			...
			listavenda = servico.vendasendereco(data_grafico, data_grafico2,vendedorfiltrado,vendedorfiltrado2, gestorfiltrado, gestorfiltrado2, clientefiltrado, clientefiltrado2);
		} else {			
			listavenda = servico.vendasendereco(data_grafico, data_grafico2,vendedorfiltrado,vendedorfiltrado2, gestorfiltrado, gestorfiltrado2, clientefiltrado, clientefiltrado2);
		}
	...
	public List<VendasEndereco> getListavenda() {
		return listavenda;
	}

	public void setListavenda(List<VendasEndereco> listavenda) {
		this.listavenda = listavenda;
	}

	public VendasEndereco getVendasEnderco() {
		return vendasEndereco;
	}

	public void setVendasEnderco(VendasEndereco vendasEndereco) {
		this.vendasEndereco = vendasEndereco;
	}
