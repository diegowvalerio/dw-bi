...
public class ServicoVendasemGeral implements Serializable{
	...
	public List<VendasEmGeral> bonificacaoexpositoremgeral(Date data1, Date data2, String vendedor1, String vendedor2, String gestor1, String gestor2,String cliente1, String cliente2){
		return dao.bonificacaoexpositoremgeral(data1, data2, vendedor1,vendedor2, gestor1, gestor2, cliente1,  cliente2);
	}
	...
	public List<VendasEmGeral> trocadefeitodiferente(Date data1, Date data2, String vendedor1, String vendedor2, String gestor1, String gestor2,String cliente1, String cliente2){
		return dao.trocadefeitodiferente(data1, data2, vendedor1,vendedor2, gestor1, gestor2, cliente1,  cliente2);
	}
	...
	public List<VendasEmGeral> investimentooemgeral_3(Date data1, Date data2, String vendedor1, String vendedor2, String gestor1, String gestor2,String cliente1, String cliente2){
		return dao.investimentoemgeral_3(data1, data2, vendedor1,vendedor2, gestor1, gestor2, cliente1,  cliente2);
	}
