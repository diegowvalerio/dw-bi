...
@Named
@ViewScoped
public class BeanBonificacaoExpositoremGeralItem implements Serializable {
	...
	public void init() {
		...
		this.listavendaitems = servico.bonificacaoexpositoremgeralitem(this.vendasEmGeral.getPedido());
	...
	public String encaminha() {
		...
		return "bonificacaoexpositoremgeral";
	}
