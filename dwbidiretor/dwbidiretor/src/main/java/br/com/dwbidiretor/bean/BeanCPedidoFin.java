...
import br.com.dwbidiretor.servico.ServicoCPedidoFin;
...
@Named
@ViewScoped
public class BeanCPedidoFin implements Serializable {
	private static final long serialVersionUID = 1L;

	private CPedidoFin cpedidofin = new CPedidoFin();
	@Inject
	private ServicoCPedidoFin servico;
	private List<CPedidoFin> lista = new ArrayList<>();
	...
	public void filtrar() {
		...
		lista = servico.cpedidofin(data_grafico, data_grafico2,vendedorfiltrado,vendedorfiltrado2, gestorfiltrado, gestorfiltrado2,clientefiltrado, clientefiltrado2, status, x);
	...
	public CPedidoFin getCpedidofin() {
		return cpedidofin;
	}

	public void setCpedidofin(CPedidoFin cpedidofin) {
		this.cpedidofin = cpedidofin;
	}

	public List<CPedidoFin> getLista() {
		return lista;
	}

	public void setLista(List<CPedidoFin> lista) {
		this.lista = lista;
	}
