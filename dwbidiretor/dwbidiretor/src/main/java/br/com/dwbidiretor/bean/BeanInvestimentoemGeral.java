...
@Named
@ViewScoped
public class BeanInvestimentoemGeral implements Serializable {
	...
	public void init() {
		...
		if ((Date) session.getAttribute("data1") != null) {
			...
			listavenda = servico.investimentooemgeral(data_grafico, data_grafico2,vendedorfiltrado,vendedorfiltrado2, gestorfiltrado, gestorfiltrado2, clientefiltrado, clientefiltrado2);
		} else {			
			listavenda = servico.investimentooemgeral(data_grafico, data_grafico2,vendedorfiltrado,vendedorfiltrado2, gestorfiltrado, gestorfiltrado2, clientefiltrado, clientefiltrado2);
		}
